...
@FeignClient(value = "tms-contract", fallback = TmsContractFddElectricSealFeignFallback.class, path = "apiPlat/tms-contract")
public interface TmsContractFddElectricSealFeign {
     ...
     * @return
     */
    @PostMapping(value = "/serviceCharge/sendFinanceFddCostContractMsg")
    @ApiOperation(value = "法大大合同签署日汇总导出")
    Result<String> sendFinanceFddCostContractMsg(@RequestBody FinanceFddCostContract message);
     ...
     * @return
     */
    @PostMapping(value = "/serviceCharge/sendFinanceFddCostAuthMsg")
    @ApiOperation(value = "法大大合同签署日汇总导出")
    Result<String> sendFinanceFddCostAuthMsg(@RequestBody FinanceFddCostAuth message);
    ...
    Result<List<FddElectricSealVo>>  queryFddVerifyAuthStatusByUserIds(@RequestBody List<String> userIds);
