...
public class IdWorker {
     ...
     */
//    public static synchronized String getSnowflakeId() {
//        return String.valueOf(nextId());
//    }
    /**
     * 这个是核心方法，通过调用nextId()方法，让当前这台机器上的snowflake算法程序生成一个全局唯一的id
     */
    private static synchronized long nextId(Long workerId) {
        // 这儿就是获取当前时间戳，单位是毫秒
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 300; i++) {
            System.out.println(getSnowflakeId(SnowflakeEnum.BANK));

            System.out.println(getSnowflakeId(SnowflakeEnum.FILE));
        }
    ...
    /**
     * 各模块生成序列号
     * @param snowflakeEnum     模块名称
     * @return  雪花id
     */
    public static synchronized  String getSnowflakeId(SnowflakeEnum snowflakeEnum){
