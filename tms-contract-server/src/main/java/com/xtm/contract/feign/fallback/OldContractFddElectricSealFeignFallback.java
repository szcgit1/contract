...
@Slf4j
@Component
public class OldContractFddElectricSealFeignFallback implements OldContractFddElectricSealFeign {
    @Override
    ...
    @Override
    public Result<String> sendMqMsg(FinanceFddCostContract message) {
        log.error("法大大发送MQ消息失败,请稍后再试");
