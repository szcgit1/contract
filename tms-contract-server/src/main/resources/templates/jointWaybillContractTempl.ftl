            ...
            <div style="margin-top: 10px;">
                <span>
                    <strong class="content-style-1" style="font-size: 10.6667px;text-indent: 0em;">
                        ...
                        <p>本合同为联合运输合同，联合运输指司机通过小铁马 APP 承接的始发地至目的地的往返运输任务。</p>
                    </strong>
                </span>
        ...
        <div style="margin-top: 10px;">
            <li style="list-style: none;line-height: 15.75pt">
                    <strong class="content-style-1">
                        <p>承运人通过托运人互联网物流平台（以下简称“平台”）向托运人提供货物运输服务。根据《中华人民共和国税收征收管理法》、《中  华人民共和国发票管理办法》、《税务机关代开增值税专用发票管理办法（试行）》、《国家税务总局关于发布&lt;货物运输业小规模纳税人申请代开增值税专用发票管理办法&gt;的公告》和《关于开展互联网物流平台企业代开增值税专用发票试点工作的通知》（税总函[2019]405
                                号）等的有关规定，为方便办理代开增值税专用发票（以下简称专用发票）及相关涉税事项，经双方友好协商，达成以下协议：</p>
