...
<div class="content">
    ...
    <div class="content-table">
        <table class="table-price">
            <tbody>
                ...
                <tr>
                    <td colspan="8">合计：含税金额人民币<#if contract.total??>${contract.total}</#if>元整。</td>
                </tr>
            </tbody>
        </table>
    </div>
    ...
    <div class="content-footer">
        <div class="bottom-user">
            ...
            <strong class="right-user" style="padding-right: 150px;">乙方：${contract.secondPartyName}</strong>
        </div>
        <br/>
        <div class="bottom-user">
            <strong class="left-user">${contract.firstPartySignTime}</strong>
            <strong class="right-user" style="padding-right: 150px;">${contract.secondPartySignTime}</strong>
        </div>
    </div>
</div>
</body>
