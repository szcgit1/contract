...
<div class="content">
    <div class="content-header">
        ...
        <div class="header-userInfo">
            <div>
                ...
                <span class="label-contact">联系人：<#if contract.trustorCompany.contact?? && contract.trustorCompany.contact.name??>${contract.trustorCompany.contact.name}</#if><#if contract.trustorCompany.contact.mobile??>
                        <b class="kindent">${contract.trustorCompany.contact.mobile}</b></#if></span>
            </div>
            <div>
                <strong>平台方：<#if contract.platCompany??>${contract.platCompany.name}</#if></strong>
                <span class="label-contact">联系人：<#if contract.platCompany.contact?? && contract.platCompany.contact.name??>${contract.platCompany.contact.name}</#if><#if contract.platCompany.contact.mobile??>
                        <b class="kindent">${contract.platCompany.contact.mobile}</b></#if></span>
            </div>
            <div>
                <strong>承运人：<#if contract.carryCompany??>${contract.carryCompany.name}</#if></strong>
                <span class="label-contact">联系人：<#if contract.carryCompany.contact?? && contract.carryCompany.contact.name??>${contract.carryCompany.contact.name}</#if><#if contract.carryCompany.contact.mobile??>
                        <b class="kindent">${contract.carryCompany.contact.mobile}</b></#if></span>
            </div>
        </div>
    </div>
            ...
            <#list contract.contractGoodsInfos as goodsInfo>
                <table>
                    ...
                    <tr>
                        ...
                        <th>
                            <label><#if goodsInfo.sendTime??> ${goodsInfo.sendTime?string("yyyy-MM-dd HH:mm:ss")}</#if></label>
                        </th>
                        <th class="back-color">计划到货</th>
                        <th>
                            <label><#if goodsInfo.sendTime??> ${goodsInfo.receiveTime?string("yyyy-MM-dd HH:mm:ss")}</#if></label>
                        </th>
                    </tr>
                    <tr>
    ...
    <div class="content-footer">
        ...
        <div class="bottom-user">
            <strong class="floatLeft">托运人：${contract.trustorCompany.name}</strong>
            <strong>平台方：${contract.platCompany.name}</strong>
            <strong class="floatRight">承运人：${contract.carryCompany.name}</strong>
        </div>
        <div class="bottom-signer">
            <span class="floatLeft">${firstKeyWord}</span>
            <span>${thirdKeyWord}</span>
            <span class="floatRight">${secondKeyWord}</span>
        </div>
    </div>
</div>
</body>
