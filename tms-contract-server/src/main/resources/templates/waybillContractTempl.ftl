    ...
    <div class="content-header">
        <div class="header-userInfo">
            <div style="margin-top: 10px;">
                <span>
                    <strong class="content-style-1" style="font-size: 10.6667px;text-indent: 0em;"><p>根据国家相关法律法规和托运人运输业务要求，经双方充分协商，特订立本合同，以便共同遵守，本合同适用于所有注册成为<span><#if contract.trustorCompany??>${contract.trustorCompany.name}</#if></span>平台（以下简称"平台"）的承运人用户。</p></strong>
                </span>
            </div>
    ...
    <div class="content-table">
            ...
            <#list contract.contractGoodsInfos as goodsInfo>
                <table style="width: 100%">
                    ...
                    <tr>
                        ...
                        <th class="fade-type" colspan="2"><#if goodsInfo.sendAddress??>${goodsInfo.sendAddress}</#if><#if goodsInfo.sendContactName??>/${goodsInfo.sendContactName}</#if><#if goodsInfo.sendContactMobile??> /${goodsInfo.sendContactMobile}</#if></th>
                        <th class="back-color">目的地</th>
                        <th class="fade-type" colspan="2"><#if goodsInfo.receiveAddress??>${goodsInfo.receiveAddress}</#if><#if goodsInfo.receiveContactName??>/${goodsInfo.receiveContactName}</#if><#if goodsInfo.receiveContactMobile??> /${goodsInfo.receiveContactMobile}</#if></th>

                    </tr>
                    <tr>
                        <th class="back-color">计划装车时间</th>
                        <th class="fade-type"><#if goodsInfo.sendTime??> ${goodsInfo.sendTime?string("yyyy-MM-dd HH:mm:ss")}</#if></th>
                        <th class="back-color">计划卸车时间</th>
                        <th class="fade-type"><#if goodsInfo.sendTime??> ${goodsInfo.receiveTime?string("yyyy-MM-dd HH:mm:ss")}</#if></th>
                        <th class="back-color">车牌号</th>
                        <th class="fade-type"><#if goodsInfo.vehicleCode??>${goodsInfo.vehicleCode}</#if></th>
                    </tr>
                    </tbody>
                </table>
                <br/>
        ...
        <table class="table-price">
            ...
            <#if contract.contractChargeInfos?? && contract.contractChargeInfos.chargeSubjectsInfos??>
                <#list contract.contractChargeInfos.chargeSubjectsInfos as contractChargeInfos>
                    <tr>
                        ...
                        <td class="tbale-money" style="text-align: center;">
            ...
            <tr>
                <th></th>
                <th>金额合计：</th>
                <th class="tbale-money fade-type" colspan="2" style="text-align:center;background-color: white; ">
        ...
        <div style="margin-top: 10px;">
            <li style="list-style: none;line-height: 15.75pt">
                    <strong class="content-style-1">
                        <p>承运人通过托运人互联网物流平台（以下简称“平台”）向托运人提供货物运输服务。根据《中华人民共和国税收征收管理法》、《中华人民共和国发票管理办法》、《税务机关代开增值税专用发票管理办法（试行）》、《国家税务总局关于发布&lt;货物运输业小规模纳税人申请代开增值税专用发票管理办法&gt;的公告》和《关于开展互联网物流平台企业代开增值税专用发票试点工作的通知》（税总函[2019]405号）等的有关规定，为方便办理代开增值税专用发票（以下简称专用发票）及相关涉税事项，经双方友好协商，达成以下协议：</p>
                        ...
                        <p>二、承运人向托运人明确，承运人向托运人提供的注册用户信息是真实的，承运人身份非增值税一般纳税人，申请代开发票对应的业务是真实的，是通过托运人互联网物流平台承接的，并承诺承担相关法律责任。</p>
                        <p>三、托运人根据承运人委托，负责代承运人办理临时税务登记、代办代开专用发票相关手续，按照税务机关要求的格式向税务机关递交代开发票申请，代承运人缴纳相关税费，取得发票和完税凭证明。承运人若需完税证明，托运人应及时转交。</p>
                        <p>四、因承运人提供的数据信息及资料不真实、不准确，或弄虚作假，由此造成的后果由承运人承担。</p>
                        <p>五、本协议应在承运人成为托运人互联网物流平台注册用户并采集相关信息后签署。本协议在托运人互联网物流平台以电子协议的形式进行签署。协议可由双方一次性签署，长期有效。</p>
                        <p>六、承运人是代开专用发票的委托人、实际承运业务的纳税义务人，应承担代开发票应缴的相关税费。托运人应按代开专用发票实际发生的税费代承运人缴纳。托运人不得向承运人额外收取其它代办涉税事项的费用。</p>
                        <p>七、承运人注册登记信息发生变化的，承运人应立即告知托运人，托运人收到承运人通知后，应立即进行信息修改，重新向税务机关申请变更承运人税务登记信息。承运人已转为一般纳税人的，应在登记一般纳税人当日或之前，通知托运人中止代开专用发票协议。</p>
                        <p>八、托运人应根据承运人的委托，根据承运人在其平台上为其发生的业务，按税务机关要求的格式，形成申请代开专用发票数据清册。托运人在向税务机关递交代开专用发票申请时，需提供上述数据清册。托运人应按照税务机关要求的格式，每月向税务机关传递在平台上交易的信息。</p>
                    </strong>
            </li>
        </div>
    </div>
